...
class HelpWindow(Toplevel):
    def __init__(self, parent, type):
        ...
        if type == "about":
            ...
            self.text.config(text="If you have any questions, concerns, or issues you can contact\n"
                                  "the developers of this project by emailing\n\npyeventlogviewer@gmail.com")
    ...
    def _place_widgets(self):
        ...
        self.main_container.grid(row=0, column=0, rowspan=2, columnspan=5, sticky='EW')

        # Information block
        self.text.grid(row=1, column=0, padx=padding, pady=padding, sticky='NESW')
        self.button_ok.grid(row=2, column=0, padx=padding, pady=padding, sticky='NESW')
