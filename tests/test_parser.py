...
def test_parser_id_104():
    xml_input = (
        ...
        '<Channel>System</Channel>'
        '<BackupPath>\\DESKTOP-C0O9EV0\\Users\\User\Desktop\System - Personal.evtx</BackupPath>'
        '</LogFileCleared>'
        '</UserData>'
        '</Event>'
    )
...
def test_parser_id_1074_wanted():
    xml_input = (
        ...
        '<Data Name="param6"/>'
        '<Data Name="param7">LAPTOP-9KUQNI2Q\\user</Data>'
        '</EventData>'
        '</Event>'
...
def test_parser_id_1102():
    ...
    assert record["details"] == ("Security event log was cleared by the following account: S-1-5-21-1990300061-"
                                 "1030431749-3499390798-1001\DESKTOP-C0O9EV0")
...
def test_parser_id_4616():
    ...
    assert (record[
        "details"]) == "Changed To: 2017-09-30 06:45:03.871 (UTC) | Previous Time: 2017-09-30 06:45:03.871 (UTC)"
...
def test_parser_id_4624():
    xml_input = (
        ...
        '<Data Name="TargetUserName">user@gmail.com</Data>'
    ...
    if reason == "2":
        ...
        assert record["description"] == "Interactive Logon"
        assert record["details"] == "Logon as MicrosoftAccount\\user@gmail.com using cached credentials"
...
def test_parser_id_4720():  # Do not have
    ...
    assert (record[
        "details"]) == "New account name: WDAGUtilityAccount (RID 04) was created by user account (DESKTOP-BPKOOQH$)"
...
def test_parser_id_4724():  # Do not have
    xml_input = (
        '<Event xmlns="http://schemas.microsoft.com/win/2004/08/events/event">'
        '<System>'
        '<Provider Name="Microsoft-Windows-Security-Auditing" Guid="{54849625-5478-4994-A5BA-3E3B0e28C30D}"/>'
        ...
        '<Opcode>0</Opcode>'
        '<Keywords>0x8020000000000000</Keywords>'
        '<TimeCreated SystemTime="2017-08-27T19:37:42.750100200Z"/>'
        '<EventRecordID>47270</EventRecordID>'
        '<Correlation ActivityID="{12F87726-1A0F-0007-41EB-12130F1AD301}"/>'
        '<Execution ProcessID="832" ThreadID="21420"/>'
        '<Channel>Security</Channel>'
        ...
        '<Data Name="TargetDomainName">LAPTOP</Data>'
        '<Data Name="TargetSid">S-1-5-21-3772361605-1561322693-719845304-1001</Data>'
        '<Data Name="SubjectUserSid">S-1-5-18</Data>'
        '<Data Name="SubjectUserName">LAPTOP$</Data>'
        '<Data Name="SubjectDomainName">WORKGROUP</Data>'
        '<Data Name="SubjectLogonId">0x00000000000003e7</Data>'
        '</EventData>'
        '</Event>'
...
def test_parser_id_6008():  # Do not have
    xml_input = (
        ...
        '<TimeCreated SystemTime="2017-10-16T08:12:54.516512700Z"/>'
        ...
        '</System>'
        '<EventData>'
        '<Data> 12:21:13 AM </Data>'
        '<Data> ‎10 / ‎16 / ‎2017 </Data>'
        '<Data/>'
        '<Data/>'
        '<Data> 259120 </Data>'
        '<Data/>'
        '<Data/>'
        '<Binary> E1070A0001001000000015000D00D802E1070A0001001000070015000D00D802600900003C00000001000000600900000'
        '1000000B00400000100000003000000 </Binary>'
        '</EventData>'
        '</Event>'
    )
    d = xmltodict.parse(xml_input)
...
def test_parse_unwanted():
    ...
    try:
        ...
        xml_unwanted = xml_unwanted.replace("\x00", "")  # This can not be the best way to do this...
        d = xmltodict.parse(xml_unwanted)
    sys = d['Event']['System']
    rec = {'timestamp_utc': sys['TimeCreated']['@SystemTime'],
           'event_id': sys['EventID'],
